  ...
  constructor(
    ...
    this.geoLocation
      ...
      .then(resp => {
        ...
        this.closest = this.httpClient.get(
          "http://krk-api.herokuapp.com/" +
            this.myLatitude +
            "," +
            this.myLongitude
        );
        this.closest.subscribe(data => {
          ...
          this.locationImgSource =
            "assets/imgs/" + data["Closest location"]["key2"] + ".jpg";
          this.tourImgSource =
            "assets/imgs/" + data["Closest tour"]["key2"] + ".jpg";
